#This file keeps some of the settings information required to obtain the NCBI entry information and to generate the appropriate primer parameters for Primer3 operation
email_address = 'your_email@example.com'
initials = 'LF'
sequence_dictionary = {'SEQUENCE_ID': 'Test', 'SEQUENCE_TEMPLATE': None}
